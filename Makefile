bin/build : lib/main.o lib/hashairlines.o lib/hashairports.o lib/structures.o lib/reader.o lib/sorter.o
	gcc lib/main.o lib/hashairports.o lib/hashairlines.o lib/structures.o lib/reader.o lib/sorter.o -o bin/build
